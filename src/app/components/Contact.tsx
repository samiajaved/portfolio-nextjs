...
export default function Contact (){
    return(
    <div>
        <div className=" w-[375px] md:w-[768px] bg-emerald-100 lg:w-full "> 
            <div className="text-center p-20 lg:px-44 lg:pb-10">
                <h1 className="text-3xl font-sans fade-in">Samia Javed Front-end Developer.</h1>
                <p className="mt-6 text-sm fade-in">I started my journey of being an AI Engineer in february 2024 in GIAIC, before that i was working in the field of 
            ...
            <div className="w-fit flex   lg:ml-[610px] ml-[140px] md:ml-[300px] lg:-mt-7 -mt-10 ">
                        <Link href='https://www.linkedin.com/in/samia-javed-samia?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app'>
                            <Image src={"/images/linkedin.png"} alt="logo" width={25} height={18} className="fade-in w-auto h-auto " />
                        </Link>
                        <Link href="mailto:samiaj380@gmail.com">
                            <Image src={"/images/email.png"} alt="mail" width={25} height={18} className="fade-in w-auto h-auto ml-[30px] lg:ml-[30px]  "/>
                        </Link>
            </div>

            <h1 className="text-3xl font-sans text-center flex mt-6  justify-center fade-in">Let&apos;s Work Together</h1>
            ...
            <div>
                        <form className=" md:ml-52 ml-8 lg:ml-[400px] mt-10 lg:w-[530px] md:w-[380px] lg:h-[700px] h-[600px]" id="form" name="form" >
                                ...
                                <button type="button" className='fade-in text-teal-900 hover:text-teal-700 border-teal-900 border-2 font-bold  pt-2  px-7  py-2  rounded-[5px] mt-7  w-[237px] h-[52px] '>Submit </button>
